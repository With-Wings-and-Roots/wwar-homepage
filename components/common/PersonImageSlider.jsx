...
const PersonImageSlider = ({ imageUrls }) => {
  ...
  return (
    <div
      className='relative h-[80vh] bg-wwr_yellow_orange'
    ...
    >
      ...
      {imageUrls?.map((image, iI) => (
        <Image
          ...
          key={iI}
          fill={true}
          className={`absolute bottom-0 !top-auto !left-[5%] !w-[90%] !h-[70vh] object-contain object-bottom transition-opacity duration-[1800ms]${
