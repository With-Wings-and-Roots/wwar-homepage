...
const FilmLanguagesDropdown = ({
  ...
  const selectedOption = options.find((opt) => opt.id === activeLanguage);
    ...
    <div className='w-full'>
      <div className='relative w-full' ref={dropdownRef}>
        ...
        {open && (
          ...
          >
            {options.map((opt, i) => {
              const isActive = activeLanguage === opt.id;
...
export default FilmLanguagesDropdown;
