...
const FilmTypeDropdown = ({
  filmTypes = [],
  activeFilmType,
  onChange,
  heading = 'Select a film type',
  allLabel = 'All Film Types',
}) => {
  ...
  const selectedOption = options.find((opt) => opt.id === activeFilmType);
    ...
    <div className='w-full'>
      <div className='relative w-full' ref={dropdownRef}>
        ...
        {open && (
          ...
          >
            {options.map((opt, i) => {
              const isActive = activeFilmType === opt.id;
