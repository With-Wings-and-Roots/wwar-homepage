        ...
        <>
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-8 xl:col-span-9">
              <Link href={createLocalLink(`/blog`)}
              ...
              {blogPost?.featured_media > 0 && (
                <ImageMedia mediaId={blogPost.featured_media} className="aspect-square object-cover md:hidden"/>
              )}
              <h1
              ...
              <WysiwygContent content={blogPost.content?.rendered} className='my-2'/>
            </div>
        ...
        <>
          ...
          <div className="mt-16">
            {posts?.length > 0 ? (
              <>
                {posts?.sort(
                  (a, b) => new Date(b.date) - new Date(a.date))?.map((post, pI) => (
                  <div className="grid grid-cols-12 gap-8 my-8" key={pI}>
                    ...
                    <div className="col-span-12 md:col-span-8 xl:col-span-9 flex flex-col">
                      ...
                      <WysiwygContent content={post.excerpt?.rendered} className='my-2'/>
                      <div className="mt-auto">
                        <Link href={createLocalLink(`/blog/${post.slug}`)}
