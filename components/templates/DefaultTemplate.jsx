...
const DefaultTemplate = ({ data, lang, timeLineEventsEn, timeLineEventsDe, allMedia, baseLink, searchParams }) => {
  return (
    <>
      <HomeWrapper lang={lang} timeLineEventsDe={timeLineEventsDe} timeLineEventsEn={timeLineEventsEn}
                   allMedia={allMedia} baseLink={baseLink} searchParams={searchParams} />
      {/*<div*/}
