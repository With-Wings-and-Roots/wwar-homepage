...
const Sidebar = ({sidebarContent}) => {
  ...
  return (
    <div>
        {sidebar_content_type === "image" && <SidebarContentTypeImage sidebarContent={sidebarContent} /> }
        {sidebar_content_type === "video" && <SidebarContentTypeVideo sidebarContent={sidebarContent} /> }
        {sidebar_content_type === "story" && <SidebarContentTypeStory sidebarContent={sidebarContent} /> }
