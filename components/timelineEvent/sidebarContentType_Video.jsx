...
const SidebarContentTypeVideo = async ({content}) => {
  ...
  const {sidebar_content_video:{video, title, caption, display_credit, credit, credit_link},  sidebar_content_quote, sidebar_content_sidenote, sidebar_content_featured_story, text } = content
