        ...
        <div className={`px-5 md:px-20 pb-20`}>
          ...
          <div className={`flex flex-wrap md:flex-nowrap gap-10`}>
            <div className={`w-full md:w-2/3`}>
              <GeneralText>
                <div className={`flex flex-col gap-6`}>
                  <p>These timelines were a collaboration driven primarily by volunteers. The selection of events
                    and
                  ...
                  <div>
                    ...
                    <p>Olga Gerstenberger, Christina Antonakos-Wallace, Serkan Demiral, Regina Knoll, Rachel
                      Landry,
                      Anna
                      Baker & Lotti Schulz
                    </p>
                  ...
                  <p>
                    Ariela Kachmer – NY Coalition Of Radical Educators, Manuela Bauche – August Bebel Institute,
                    Tahir
                    Della – Initiative of Black Germans., Sharon Dodua Otoo, Julius Franklin, Nadine Golly –
                    Leuphana
                    University Lüneburg, Handan Kaymak, Berivan Inci – Antidiscrimination Network Berlin of the
                    Turkish
                    Union Berlin, Beate Klammt – Anne Frank Center, Jacob Langford – Humboldt University Berlin,
                    Nzitu
                    Tahir, John Mukiibi – Anti-discrimination Office Cologne, Kofi Ohene-Dokyi – Project JUMA,
                    Cigir
                    Özyurt, Youth Theater Buro Berlin, Judith Rahner, Amadeu Antonio Foundation, Salma Rafiq-Haya
                    –
                    Gladt
                    e.V.,Yasemin Shooman, Academy of the Jewish Museum Berlin, Nursemin Sönmez, Gülsah Stapel,
                    Serdar
            ...
            <div className={`w-full sm:w-1/3 shrink-0 text-wwr_gray_storm flex flex-col gap-6`}>
              <div>
                <Image className={`aspect-square w-full h-full`} width={400} height={400}
                       src={"/Serkan_headshot.jpg"}
                       alt={"Serkan Demiral"} />
              </div>
              <div className={`font-normal text-wwr_black text-2xl`}>In Memory of Serkan Demiral</div>
              <div><GeneralText>
                <p>This timeline is dedicated to our dear collaborator, Serkan Demiral, who gave much of his time
                  during
                  a long battle with cancer to With Wings and Roots. Among his contributions, he was an editor for
                  the
                  German timeline. Serkan brought a sharp mind, a huge heart, an expanse of generosity, and
                  wonderful
                  sense of humor to our team. He is greatly missed.

                </p>
                <p className={`italic`}>These timelines are always evolving. We welcome your feedback and
                  collaboration:
